...
let HttpExceptionFilter = class HttpExceptionFilter {
        ...
        if (finalException instanceof common_1.HttpException) {
            ...
            if (typeof exceptionResponse === 'string') {
                ...
                message = res['message'] ?? finalException.message;
                error = res['error'] ?? '';
            }
        }
        ...
        if (typeof exception === 'object' &&
            ...
            switch (prismaError.code) {
                case 'P2002': {
                    ...
                    return new common_1.ConflictException(`A record with this ${fields} already exists`);
                }
                case 'P2025':
                    return new common_1.NotFoundException('Record not found');
                default:
                    return null;
            }
        }
