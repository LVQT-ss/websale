...
exports.TemplatesModule = TemplatesModule = __decorate([
    (0, common_1.Module)({
        controllers: [templates_controller_js_1.TemplatesController, templates_controller_js_1.AdminTemplatesController],
        providers: [templates_service_js_1.TemplatesService],
        exports: [templates_service_js_1.TemplatesService],
    })
], TemplatesModule);
